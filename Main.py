...
repo_name = "final_youtube_uploader"
os.makedirs(repo_name, exist_ok=True)

# main.py (simplified working version with logging)
main_py = """import os, random, time, schedule
...
os.makedirs(os.path.join(repo_name, "images"), exist_ok=True)
os.makedirs(os.path.join(repo_name, "music"), exist_ok=True)
